...
int main() {
    ...
    Renderer renderer(1024, 768, 16);

    renderer.setCameraPosition(50, 50, 295.6);
    renderer.setCameraDirection(0, -0.042612, -1);

//    renderer.importCamera("../scenes/cameras/cornell_box_1_camera.csv");
//    renderer.importWorld("../scenes/worlds/cornell_box_1_world.csv");
    ...
    renderer.exportWorld("cornell_box_1_world.csv");
    renderer.exportCamera("cornell_box_1_camera.csv");
